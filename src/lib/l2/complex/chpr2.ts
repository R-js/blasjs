...
import { Complex, errMissingIm, errWrongArg, FortranArr, isZero, lowerChar } from '../../f_func';
        ...
        for (let j = 1; j <= n; j++) {
            ...
            if (!xIsZero || !yIsZero) {
                ...
                ap.r[kk + j - 1 - ap.base] +=
                    ...
                    x.i[jx - x.base] * temp1Im + //REAL(y[jy-y.base]*temp2)
        ...
        for (let j = 1; j <= n; j++) {
            ...
            if (!(xIsZero && yIsZero)) {
                ...
                for (let k = kk + 1; k <= kk + n - j; k++) {
                    ...
                    ap.r[k - ap.base] +=
                        x.r[ix - x.base] * temp1Re -
                        x.i[ix - x.base] * temp1Im +
                        (y.r[iy - y.base] * temp2Re - y.i[iy - y.base] * temp2Im);
                    ap.i[k - ap.base] +=
                        x.r[ix - x.base] * temp1Im +
                        x.i[ix - x.base] * temp1Re +
