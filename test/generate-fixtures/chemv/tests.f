      ...
      EXTERNAL ZHEMV, COPY, ZEROA, COPYMA,FILL
      ...
      COMPLEX*16 ALPHA, ACUP(LDA,N), ACLO(LDA,N)
      COMPLEX*16 BETA
     ...
     +  ( -0.11775359816595128 ,-0.27577802908802723)/
      ...
      PRINT * , "==CASE 0======="
        ...
        Y(4) =  (0,0)
        Y(2) =  (0,0)
c         ZHEMV(UPLO,N,ALPHA,A   ,LDA,X,INCX,BETA,Y,INCY)
        CALL ZHEMV(UPLO, N, ALPHA, ACUP, LDA, X, INCX, BETA, Y, INCY)
...
c         ZHEMV(UPLO,N,ALPHA,A   ,LDA,X,INCX,BETA,Y,INCY)
        ...
        Y(2) =  (0,0)
c         ZHEMV(UPLO,N,ALPHA,A   ,LDA,X,INCX,BETA,Y,INCY)
        CALL ZHEMV(UPLO, N, ALPHA, ACLO, LDA, X, INCX, BETA, Y, INCY)
